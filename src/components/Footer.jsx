        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-16">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-700">
              ...
              <li><a href="tel:+1234567890" className="hover:text-slate-900 transition">+91 9746816609, +91 9746826609</a></li>
              <li><Link to="/about" className="hover:text-slate-900 transition"> Yatrasutra Holidays Pvt Ltd
Penta Corner Building, Changampuzha Metro Station, Edapally, Kochi</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <a aria-label="Facebook" href="https://www.facebook.com/people/Yatra-Sutra/61574118189623/" className="grid h-9 w-9 place-items-center rounded-lg border border-white/40 bg-white text-orange-600 shadow-sm backdrop-blur-sm transition hover:bg-white/60">
