          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-slate-700">
              <li className="flex items-start">
                ...
                <a href="mailto:info@yatrasutra.com" className="hover:text-slate-900 transition">info@yatrasutra.com</a>
              </li>
              <li className="flex items-start">
                <MdPhone className="text-orange-600 mt-1 mr-2 flex-shrink-0" />
                <a href="tel:+1234567890" className="hover:text-slate-900 transition">+91 9746816609, +91 9746826609</a>
              </li>
              <li className="flex items-start">
                <IoLocationSharp className="text-orange-600 mt-1 mr-2 flex-shrink-0" />
                <Link to="/about" className="hover:text-slate-900 transition">Yatrasutra Holidays Pvt Ltd, 
Penta Corner Building, Changampuzha Metro Station, Edapally, Kochi</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              <a aria-label="Instagram" href="https://www.instagram.com/yatra.sutra?igsh=MXJ4cm5tNWVyMjc=" className="grid h-9 w-9 place-items-center rounded-lg border border-white/40 bg-white text-orange-600 shadow-sm backdrop-blur-sm transition hover:bg-white/60">
              ...
              <a aria-label="Facebook" href="https://www.facebook.com/people/Yatrasutra-Holidays/61575130194369/?rdid=G7DnXyLX2yfTB9zW&share_url=https%3A%2F%2Fwww.facebook.com%2Fshare%2F1BHSdmVZUh%2F" className="grid h-9 w-9 place-items-center rounded-lg border border-white/40 bg-white text-orange-600 shadow-sm backdrop-blur-sm transition hover:bg-white/60">
